...
public void testGetAll() {
    	Show test1 = insertShow("O škole a lidech", "Pravdivá, i když děsivá upomínka", 123, "Horor", "Po pĹůlnoci nedívat");
...
Show test = insertShow("O škole a lidech", "Pravdivá, i když děsivá upřímná", 123, "Horor", "Po půlnoci nedívat");
Show test2 = TestUtils.createShow("Ve větru",  "I tam se dějí věci",  TestUtils.createGenre("Komedie",  "Je, byla, bude"),  123);
test2.setId(null);;
...
public void testRemove() {
	Show test1 = insertShow("O škole a lidech", "Pravdivá, i když děsivá upomínka", 123, "Horor a další předpůlnoční", "Po pĹůlnoci nedívat");
...
public void testUpdate() {
    	 Show test = insertShow("Co stalo se před půlnocí", "Příběh ne úplně vydařeného školního projektu", 144, "Tragikomedie", "I tak to někdy dopadá");
