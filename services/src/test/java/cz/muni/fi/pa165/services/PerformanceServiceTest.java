...
public class PerformanceServiceTest extends AbstractTestNGSpringContextTests {
    ...
    public void setup() {
        ...
        opera = createGenre(1L, "Opera", "V�n�");
        comedy = createGenre(2L, "Komedie", "Ne �pln� v�n�");
        show1 = createShow(1L, "Cesta na severn� p�l", "Nezn�te?", 175, comedy);
        show2 = createShow(2L, "Rusalka", "Celkem zn�m�", 265, opera);
        theatre = createHall(1L, "Divadlo na kope�ku", 350L);
        cinema = createHall(2L, "Kino pod kopcem", 200L);
        performance1 = createPerformance(10L, "Prvn� p�edstaven�", show1, theatre, LocalDateTime.now(), 79.9f);
