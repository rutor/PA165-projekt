...
public class RoleController{
    ...
    public String list(Model model) {
        model.addAttribute("role", roleFacade.getAllRole());
        return "role/list";
    }
    ...
    public String delete(@PathVariable long id, UriComponentsBuilder uriBuilder,
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("alert_danger",
                    "Role \"" +role.getName() + "\" cannot be deleted, it might be used for a user.");
        }
    ...
    public String create(@Valid @ModelAttribute("roleCreate") CreateRoleDTO formBean, BindingResult bindingResult,
        ...
        return "redirect:" + uriBuilder.path("/role/{id}").buildAndExpand(id).encode().toUriString();
    }
    /**
    ...
    public String edit(@Valid @ModelAttribute("roleEdit") RoleDTO formBean, BindingResult bindingResult,
        ...
        return "redirect:" + uriBuilder.path("/role/{id}").buildAndExpand(formBean.getId()).encode().toUriString();
    }
}
