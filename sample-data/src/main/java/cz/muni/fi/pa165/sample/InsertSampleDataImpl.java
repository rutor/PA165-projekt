...
public class InsertSampleDataImpl implements InsertSampleData {
    ...
    public void insertData() {
        ...
        Performance performance1 = createPerformance(null, "The only chance to see", 15.0f, bigHall, BalletFashion, LocalDateTime.parse("2019-02-03T10:15:00", DateTimeFormatter.ISO_LOCAL_DATE_TIME));
        Performance performance2 = createPerformance(null, "Performance", 12.0f, hall400,Zelary, LocalDateTime.parse("2019-01-23T10:15:00", DateTimeFormatter.ISO_LOCAL_DATE_TIME));
        Performance performance3 = createPerformance(null, "Performance", 12.0f, hall500,Company, LocalDateTime.parse("2019-02-04T9:00:00", DateTimeFormatter.ISO_LOCAL_DATE_TIME));
        Performance performance4 = createPerformance(null, "The best performance", 18.0f, bigHall, BedrichSmetana, LocalDateTime.parse("2019-02-13T10:30:00", DateTimeFormatter.ISO_LOCAL_DATE_TIME));
